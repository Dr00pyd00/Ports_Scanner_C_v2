...
// static Declaration ================================================
static int get_next_port(struct scan_context *ctx);
static int createEmptySocket(void);
static int createClientSocket(const char *host, int port, struct sockaddr_in* s_addr_out);
